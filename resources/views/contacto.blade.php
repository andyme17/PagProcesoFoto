...
@section('content')
<div class="container mt-5 py-3 font-secondary">
    <div class="row">
        ...
        <div class="col-12 col-md-5 pt-5">
             <div class="col-12 col-md-10 pb-4">
                <h5 class="titulo"><i class="fas fa-phone"></i> Teléfonos</h5>
                <hr>
            ...
            <div class="col-12 col-md-10 pb-4">
                <h5 class="titulo"><i class="fas fa-mail-bulk"></i> Email(s): </h5>
                <hr>
